...
const TeamSuggest = new SlashCommandBuilder()
  ...
  .addStringOption((option) =>
    option.setName("קבוצות").setDescription("כמה קבוצות להגריל")
  );
...
const FAQ = new SlashCommandBuilder()
  ...
  .addStringOption((option) =>
    option.setName("שאלה").setDescription("מה השאלה").setRequired(true)
  )
  .addStringOption((option) =>
    option.setName("תשובה").setDescription("מה התשובה").setRequired(true)
  );
